...
import { BillingEntry } from './billingColumns';

export interface BillingTableProps {
  columns: ColumnDef<BillingEntry>[];
  data: BillingEntry[];
...
export function BillingTable({
  ...
  return (
    <div className="mx-[20px] flex flex-col gap-[24px]">
      ...
      <div className="flex min-h-[600px] flex-col rounded-lg border border-gray-200 bg-white shadow-table">
