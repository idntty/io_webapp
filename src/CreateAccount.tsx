        ...
        <Main>
          <Content>
            <MainText>
              ...
              <MainDescription>
                We will securely encrypt and store the key you just created.
                This key is stored locally in your browser. Each time we request
                it, you will know and agree to access it.
              </MainDescription>
            </MainText>
            <Actions>
              <ContinueButton href="/identity-page">
                <ContinueButtonBase>
                  ...
                  <ContinueButtonText>Create my account</ContinueButtonText>
                </ContinueButtonBase>
              </ContinueButton>
              <DividerWithText>
                <InlineDivider />
                <DividerText>Will enter the passphrase every time</DividerText>
                <InlineDivider />
              </DividerWithText>
