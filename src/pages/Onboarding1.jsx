...
const Onboarding1 = observer(() => {
  ...
  if (store.passPhrase) return <Navigate to="/digitalId/profile-id" replace={true} />;
                  ...
                  <div className="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                    <label className="flex-1 relative block cursor-pointer">
                      ...
                      <div className="h-full text-center bg-white px-4 py-6 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                        ...
                        <div className="text-sm">Private, encrypted and personal</div>
                      </div>
                      <div
                    ...
                    <label className="flex-1 relative block cursor-pointer">
                      <input disabled type="radio" name="radio-buttons" className="peer sr-only" />
                      <div className="h-full text-center bg-white px-4 py-6 rounded border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                        <svg
                          className="inline-flex w-10 h-10 shrink-0 fill-current mb-2"
                          viewBox="0 0 40 40"
                        ...
                        <div className="font-semibold text-slate-800 mb-1">Authority</div>
                        <div className="text-sm">Public, open for business</div>
                      </div>
                      <div
                        className="absolute inset-0 border-2 border-transparent peer-checked:border-indigo-400 rounded pointer-events-none"
                        aria-hidden="true"
                  ...
                  <div className="flex items-center justify-between space-x-6 mb-8">
                    <div>
                      ...
                      <div className="text-xs font-normal leading-6">
                        I understand that a test network is being used. All data stored in the test
                        network can be deleted at any time, and the functionality can be changed
                        during use
                      </div>
                    </div>
